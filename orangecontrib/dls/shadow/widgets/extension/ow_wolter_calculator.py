...
from orangecontrib.dls.shadow.util.wolter1 import recipe1, recipe2, recipe3, recipe4, rotate_and_shift_quartic
from orangecontrib.dls.shadow.util.shadow_objects import ConicCoefficientsPreProcessorData
...
class OWWolterCalculator(OWWidget):
    ...
    usage_path = os.path.join(resources.package_dirname("orangecontrib.dls.shadow.widgets.extension"), "icons", "use_wolter.png")
