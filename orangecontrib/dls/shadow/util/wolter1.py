import numpy
from orangecontrib.dls.shadow.util.conic_penelope import ellipsoid, hyperboloid, paraboloid, rotate_and_shift_quartic, euler_rotation_matrix

from orangecontrib.dls.shadow.util.conics_from_factory_parameters import ellipsoid as fac_ellipsoid
from orangecontrib.dls.shadow.util.conics_from_factory_parameters import paraboloid as fac_paraboloid
from orangecontrib.dls.shadow.util.conics_from_factory_parameters import hyperboloid as fac_hyperboloid
from orangecontrib.dls.shadow.util.conics_from_factory_parameters import ken_ellipsoid, ken_hyperboloid, ken_paraboloid
